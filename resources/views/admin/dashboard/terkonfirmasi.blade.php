                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="d-none d-lg-table-cell">
                              <a href="{{asset('/event/dokumen/' .$eventall->dokumen)}}" style="overflow: hidden; white-space: nowrap;text-overflow: ellipsis; width: 250px; display: block;">{{ $eventall->dokumen }}</a>
                            </td>
                            <td >
                              <span class="badge badge-success">{{ $eventall->status }}</span>
                            </td>
                            <td class="text-right">
