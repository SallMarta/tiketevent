					...
					<table class="table table-hover ">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a type="button" class="btn btn-primary btn-block mb-1 mdi mdi-pencil" href="{{ ('/kategorievent/'.$kategorieventall->id .'/ubah') }}"> Ubah</a>
									<form action="{{ ('/hapuskategorievent/'.$kategorieventall->id) }}" method="post">
										@method('delete')
										@csrf
		...
		<div class="col-lg-4">
			<div class="card card-default">
				...
				<div class="card-body pb-0 pt-3">
					<form class="form" role="form" autocomplete="off" method="post" action="{{ url('/tambahkategorievent') }}">
						@method('post')
						@csrf
