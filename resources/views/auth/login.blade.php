...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-light bg-white sticky-top">
    ...
    <div class="mx-auto order-0">
      <a class="navbar-brand mx-auto font-italic font-bold" href="{{ ('/') }}"><img class="logo-logo" src="{{asset('/bahanuser/img/TT-Logo.png')}}" alt="" loading="lazy"></a>
          ...
          <div class="login-form">
            ...
            <form method="post" action="{{ url('/postlogin') }}">
              ...
              <div class="group-input">
                <label for="username"><span class="fas fa-envelope-open-text"></span> Email *</label>
              ...
              <button type="submit" class="site-btn login-btn"><span class="fas fa-sign-in-alt"></span> Masuk</button>
            </form>
            <div class="switch-login">
              <span>Belum punya akun? <a href="{{ url('/register') }}" class="or-login">Buat Akun sekarang</a></span>
            </div>
          </div>
        </div>
      </div>
