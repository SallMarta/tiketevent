            ...
            <nav class="navbar navbar-static-top navbar-expand-lg">
              ...
              <div class="search-form d-none d-lg-inline-block">
                <div class="input-group">
                  ...
                  <input type="text" name="query" id="search-input" class="form-control" placeholder="Cari sesuatu disini"
                    autocomplete="off"/>
                </div>
                ...
                <ul class="nav navbar-nav justify-content-end">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="/dashboarduser/assets/img/user_default.png" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block">{{ ucfirst(auth()->user()->name) }}</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="/dashboarduser/assets/img/user_default.png" class="img-circle" alt="User Image" />
