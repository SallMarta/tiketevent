  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12 col-lg-6 col-sm-12 text-center mb-4">
        <img src="{{asset('/event/poster_event/' .$detailseni->poster_event)}}" class="img-detail-event">
      </div>
      <div class="col-md-12 col-lg-6 col-sm-12">
        <h1 class="text-center event-detail-title">{{ $detailseni->nama_event }}</h1>
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active mt-4" id="detail" role="tabpanel" aria-labelledby="detail-tab">
            ...
            <p>Kategori Event: {{ $detailseni->nama_kategorievent }}</p>
            <p><span class="fas fa-calendar-day"></span> {{ date('j-F-Y', strtotime($detailseni->tanggal_mulai)) }}</p>
            <p><span class="fas fa-map-marker-alt"></span> {{ $detailseni->nama_tempat }}, {{ $detailseni->alamat_event }}</p>
            <!-- <p><span class="fas fa-clock"></span> 17.00 s/d 23.00</p> -->
            <p class="mt-5">{{ $detailseni->deskripsi }}</p>
            <div class="row">
              <div class="col-lg-12">
                <!--carousel-->
          ...
          <div class="tab-pane fade mt-4" id="rules" role="tabpanel" aria-labelledby="rules-tab">
            <p>{{ $detailseni->syarat_ketentuan }}</p>
          </div>
        </div>
      </div>
    </div>
